"""
Django settings for search_turism project.
...
ROOT_URLCONF = "search_turism.search_turism.urls"
...
WSGI_APPLICATION = "search_turism.search_turism.wsgi.application"
...
#             'filename': os.getenv('DJANGO_LOG_FILE', './search_turism.log'),
#             'formatter': 'simple'
#         },
#     },
#     'loggers': {
