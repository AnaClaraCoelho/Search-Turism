...
def edit_todo(id, city, touristSpot, description, url_image):
    todo_update = Todo.objects.get(id=id["id"])
    todo_update.description = description
    todo_update.city = city
    todo_update.tourist_spot = touristSpot
    todo_update.url_image = url_image
    todo_update.save()
    return {"todo updated": todo_update}